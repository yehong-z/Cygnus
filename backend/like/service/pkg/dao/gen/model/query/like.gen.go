...
func newLike(db *gorm.DB, opts ...gen.DOOption) like {
	...
	_like.ObjectID = field.NewInt64(tableName, "object_id")
	_like.Type = field.NewInt64(tableName, "type")
...
func (l *like) updateTableName(table string) *like {
	...
	l.ObjectID = field.NewInt64(table, "object_id")
...
func (l *like) fillFieldMap() {
	...
	l.fieldMap["object_id"] = l.ObjectID
